...
- 保证 `student_profiles.profile` 可以由当前 `memory_events` 从 demo 初始画像重放得到。
...
-> 从 demoStudentProfile 起始，用 applyMemoryDeltaToProfile 逐条合并
...
-> 从 demoStudentProfile 起始按 created_at asc, id asc 重放
